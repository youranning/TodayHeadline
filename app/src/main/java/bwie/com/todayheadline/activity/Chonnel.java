...
/**
 * Created by $USER_NAME on 2017/5/20.
 */
...
import bwie.com.todayheadline.ChannelManger.newsdrag.adapter.DragAdapter;
import bwie.com.todayheadline.ChannelManger.newsdrag.adapter.OtherAdapter;
...
import bwie.com.todayheadline.ChannelManger.newsdrag.view.DragGrid;
import bwie.com.todayheadline.ChannelManger.newsdrag.view.OtherGridView;
 ...
 */
public class        Chonnel  extends Activity implements AdapterView.OnItemClickListener {
    /** 用户栏目的GRIDVIEW */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chonnel);
        initView();
        initData();
    }
...
//        SharedPreferences sp = getApplication().getSharedPreferences("tab", MODE_PRIVATE);
    ...
    private void initView() {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveChannel();
                EventBus.getDefault().post(new TableShuaxing(1));
